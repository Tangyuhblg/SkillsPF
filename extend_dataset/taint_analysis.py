...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument("target", nargs="?", default=r"/root/crawler_data/datasets/data_bu", help="待分析的 Python 文件或项目目录")
    parser.add_argument("--json", dest="json_path", default=r"/root/crawler_data/datasets/data_bu/pdg_taint_result.json", help="将 findings 保存为 JSON")
    parser.add_argument(
